						...
						<section>
							...
							<div className="grid gap-3 md:grid-cols-3">
								{continueArticles.length > 0 ? continueArticles.map((post) => (
									...
									<Link href={featuredArticle ? `/${featuredArticle.slug}` : '/posts'} className="rounded-2xl border border-neutral-200 bg-white p-4 transition hover:border-blue-300 dark:border-neutral-800 dark:bg-neutral-900">
										...
										<p className="mt-2 text-xs leading-relaxed text-neutral-500 dark:text-neutral-400">Begin with a durable article, then follow related concepts from there.</p>
									</Link>
								)}
							</div>
						</section>
								...
								<div className="grid gap-6 lg:grid-cols-[minmax(0,1.15fr)_minmax(320px,0.85fr)]">
									...
									>
										...
										<div className="p-5 md:p-6">
											...
											<p className="mt-5 text-sm font-bold text-blue-600 dark:text-blue-300">Read deep dive</p>
										</div>
									</Link>
									...
									{topicGraphNodes.slice(0, 5).map((node, index) => (
										...
										>
											...
											<span>
												...
												<span className="mt-0.5 block text-[11px] text-neutral-500 dark:text-neutral-400">{node.count} articles</span>
											</span>
										</button>
									))}
								</div>
							...
							<div className="mt-5 flex flex-col gap-5">
								...
								{filteredPosts.length > 0 ? (
									...
									<div className="rounded-2xl border border-dashed border-neutral-300 px-6 py-10 text-center dark:border-neutral-700">
										<h2 className="text-lg font-semibold text-neutral-900 dark:text-neutral-50">No articles match the current filters</h2>
