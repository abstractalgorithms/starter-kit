		...
		<AppProvider publication={publication} footerPosts={footerPosts}>
			<Layout>
				<Head>
					...
					<meta name="description" content={`AI-curated learning paths for technical interviews — System Design, Distributed Systems, ML and more.`} />
					...
					<div className="max-w-6xl mx-auto w-full px-5 pt-10 pb-20">
							...
							<div className="rounded-xl border border-neutral-200 dark:border-neutral-800 p-8">
								<div className="flex items-center gap-3 mb-6">
									...
									<span className="text-sm text-neutral-500 dark:text-neutral-400">
										Building your personalised <span className="font-semibold text-neutral-700 dark:text-neutral-300">{selected?.label}</span> learning path…
									</span>
								</div>
						...
						{loadState === 'error' && (
							<div className="rounded-xl border border-red-200 dark:border-red-900 bg-red-50 dark:bg-red-950/20 p-8 text-center">
								<p className="text-sm text-red-600 dark:text-red-400 mb-3">Could not generate the learning path. Please try again.</p>
								<button
