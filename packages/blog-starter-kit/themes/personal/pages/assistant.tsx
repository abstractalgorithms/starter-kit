		...
		<AppProvider publication={publication} footerPosts={footerPosts}>
			<Layout>
				<Head>
					...
					<meta
						name="description"
						content="A quiet engineering mentor for explanations, comparisons, follow-up questions, and production intuition."
					/>
					<meta property="og:title" content={`AI Mentor - ${publication.title}`} />
					<meta property="og:description" content="Ask for a clearer mental model, architecture comparison, or next concept without leaving the article-first experience." />
						...
						<div className="mb-3 flex items-center justify-between xl:hidden">
							<div>
								...
								<h1 className="mt-1 text-xl font-bold text-neutral-950 dark:text-neutral-50">
									Ask for a clearer mental model.
								</h1>
							</div>
						</div>
									...
									{!loading && currentTurn ? (
										...
										{activeTab === 'roadmap' ? (
											<section className="rounded-xl border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 p-4">
												...
												<CTALink href="/discover#topic-collections" level={2} size="sm" className="mt-3">
													Related Concepts
												</CTALink>
											</section>
										) : null}
						...
						{mobileMentorTrayOpen ? (
							<div className="mx-auto mb-3 max-w-xl rounded-3xl border border-neutral-200 bg-white p-3 shadow-2xl dark:border-neutral-800 dark:bg-neutral-950">
								...
								<div className="mt-3 grid grid-cols-3 gap-2 text-center text-[11px] font-semibold">
									...
									<Link href="/discover" className="rounded-xl bg-neutral-50 px-2 py-2 text-neutral-600 dark:bg-neutral-900 dark:text-neutral-300">Explore</Link>
									<Link href="/posts" className="rounded-xl bg-neutral-50 px-2 py-2 text-neutral-600 dark:bg-neutral-900 dark:text-neutral-300">Articles</Link>
								</div>
							</div>
						) : null}
