...
<div className="flex flex-row items-center gap-2 text-xs text-neutral-500 dark:text-neutral-400 mt-auto pt-3 border-t border-neutral-200 dark:border-neutral-800 w-full justify-between">
...
<ProgressBadge postId={slug} postTitle={title} size="sm" />
</div>
</section>
</div>
</Link>
