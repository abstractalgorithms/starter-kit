...
export const Analytics = () => {
	...
	useEffect(() => {
		if (!isProd || !appContext) return;

		const { publication, post, page } = appContext;
		_sendPageViewsToHashnodeGoogleAnalytics();
		_sendViewsToHashnodeInternalAnalytics(publication);
		_sendViewsToAdvancedAnalyticsDashboard(publication, post, page);
	}, [appContext]);
